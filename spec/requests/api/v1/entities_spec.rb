...
RSpec.describe "/api/v1/entities", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get api_v1_entities_url, headers: valid_headers, as: :json
  ...
  describe "GET /show" do
    it "renders a successful response" do
      ...
      get api_v1_entity_url(entity), as: :json
      expect(response).to be_successful
    end
  end
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Entity" do
        expect {
          post api_v1_entities_url, params: { entity: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Entity" do
        expect {
          post api_v1_entities_url, params: { entity: invalid_attributes }, as: :json
        }.to change(Entity, :count).by(0)
      end

      it "renders a JSON response with errors for the new entity" do
        post api_v1_entities_url, params: { entity: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      it "updates the requested entity" do
        entity = Entity.create! valid_attributes
        patch api_v1_entity_url(entity), params: { entity: new_attributes }, headers: valid_headers, as: :json
        entity.reload
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the entity" do
        entity = Entity.create! valid_attributes
        patch api_v1_entity_url(entity), params: { entity: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq("application/json; charset=utf-8")
      end
    end
  ...
  describe "DELETE /destroy" do
    it "destroys the requested entity" do
      entity = Entity.create! valid_attributes
      expect {
        delete api_v1_entity_url(entity), headers: valid_headers, as: :json
